...
//}
//bool Train::check_compartments_passengers() {
//	Compartment* current = head;
//	do {
...
//	return true;
//}
//bool Train::check_compartments_capacity() {
//	Compartment* current = head;
//	do {
...
//	return true;
//}
//void Train::minimum_passenger_rule() {
//	if (head) {
...
//	}
//}
//void Train::maximum_capacity_rule() {
//	if (head) {
//		Compartment* previous = head;
//		Compartment* forwards = previous->get_next();
...
//		int passengers;
//		do {
//			cout << "Compartment " << (i + 1) << " - Enter Passengers (0-10): ";
//			cin >> passengers;
//			if (passengers < 0 || passengers > 10) {
//				cout << "Invalid input. Must be between 0 and 10.\n";
//			}
//		} while (passengers < 0 || passengers > 10);
//
