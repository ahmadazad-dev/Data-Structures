...
//	}
//}
//void LinkedList::read(string file_name) {
...
//	this->print(head);
//}
//int LinkedList::clue_row(int data){
//	int clue = 0;
//	while (data > 0) {
//		clue += data % 10;
//		data /= 10;
...
//	return clue;
//}
//int LinkedList::clue_column(int data) {
//	int clue = 0;
//	while (data > 0) {
//		clue += 1;
//		data /= 10;
...
//	return clue;
//}
//void LinkedList::visited(Node* current) {
...
//	}
//}
//void LinkedList::elite_node(Node* elite) {
//	cout << "\nElite Node Found: ";
//	elite->print_node();
//	exit(0);
//}
